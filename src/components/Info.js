      ...
      <section id="help-page">
        ...
        <div className="info-text">
          ...
          <br />
            ...
            <p>
            From the sidebar you can select, filter and delete the default places.
            When a place is selected on the map or in the sidebar an info - window will open on the map that
            will let you get more information about that place using Wikipidia api.
            </p>
            <p>
            Using the sidebar “Search for new places” section it’s also possible to find new places
            from wikipedia api that are inside the map extension.
            Once you have found an interesting place you can save it to “my places”
            using the corresponding save button in the sidebar.
